 ...
 *
 **********************************************************************
 * migrate_rocksdb_to_classiclevel.js
 *
 ...
 *
 * Usage:
 *   node migrate_rocksdb_to_classiclevel.js --src <rocksdb-dir> --dst <classic-level-dir>
 *   node migrate_rocksdb_to_classiclevel.js --verify-only --src <rocksdb-dir> --dst <classic-level-dir>
 *
 * Options:
...
;(async () => {
    ...
    if (a.help || !a.src || !a.dst) {
        console.log('usage: node migrate_rocksdb_to_classiclevel.js --src <rocksdb-dir> --dst <classic-level-dir> [--verify-only] [--no-verify] [--batch-bytes N]')
