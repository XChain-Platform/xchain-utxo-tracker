...
//
// Extends test/unit/key_schema_invariant.test.js, which pins the schema
...
function outputClusterScanTests() {
...
describe('Fuzz: key-schema over mainnet-scale distributions', function () {
  describe('rangeEnd exactness', rangeMembershipTests);
  describe('rangeEnd exactness', rangeNeighborTests);
});

describe('Fuzz: key-schema over mainnet-scale distributions', function () {
  describe('range-scan exactness on a real DB', outputClusterScanTests);
  describe('range-scan exactness on a real DB', keyPatternScanTests);
});
