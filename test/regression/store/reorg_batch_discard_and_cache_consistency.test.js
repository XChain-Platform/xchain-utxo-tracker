...
//
// hasOutputForTx is the page-independent confirmed-store membership probe that
// avoids emitting a just-mined outpoint from BOTH the mempool store (page 1) and
