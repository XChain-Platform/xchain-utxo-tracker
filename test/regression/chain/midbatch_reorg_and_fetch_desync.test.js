...
//
// A node pruned past the tracked cursor (or any permanent fetch fault) must not
// become an infinite 3s retry loop with no fail-loud signal. noteBlockFetchFailure
