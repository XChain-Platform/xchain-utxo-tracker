...
} = require('../helpers/observability_metrics_registration.js');
const {
...
} = require('../helpers/observability_log_shipper_registration.js');
const {
...
} = require('../helpers/observability_health_registration.js');
