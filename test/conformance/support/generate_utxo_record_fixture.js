...
// test/conformance/utxo_record_emit.test.js) and xchain-encoder (consumer gate
// conformance, test/conformance/utxoRecordConformance.test.js, over a vendored
// byte-identical copy). Regenerate with:
//   node test/conformance/support/generate_utxo_record_fixture.js
...
const {
    ...
    createTestTracker,
    closeTracker
} = require('../../integration/support/helpers.js');
