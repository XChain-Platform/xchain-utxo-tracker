...
function registerBatchAtomicityTest() {
...
function registerBatchRetryTest() {
...
function registerBatchBalanceTest() {
...
function registerDiskRetryTest() {
...
function registerCrashStateTest() {
...
function registerCrashRecoveryTest() {
...
function registerRepeatedCrashTest() {
...
function registerLatencyResultTest() {
...
function registerLatencyTimingTest() {
...
function registerLatencyRestoreTest() {
...
describe('Chaos: Storage Faults', function () {
  ...
  describe('Exp 1: Batch Write Failure', function () {
    registerBatchAtomicityTest();
  });
  describe('Exp 1: Batch Write Failure', function () {
    registerBatchRetryTest();
  });
  describe('Exp 1: Batch Write Failure', function () {
    registerBatchBalanceTest();
  });
  describe('Exp 9: Disk Full During Write', function () {
    registerDiskRetryTest();
  });
  describe('Exp 9: Disk Full During Write', function () {
    registerDiskReadTest();
  });
});
...
describe('Chaos: Storage Faults', function () {
  ...
  describe('Exp 7: Process Crash Mid-Batch', function () {
    registerCrashStateTest();
  });
  describe('Exp 7: Process Crash Mid-Batch', function () {
    registerCrashRecoveryTest();
  });
  describe('Exp 7: Process Crash Mid-Batch', function () {
    registerRepeatedCrashTest();
  });
  describe('Exp 2: Read Latency Injection', function () {
    registerLatencyResultTest();
  });
  describe('Exp 2: Read Latency Injection', function () {
    registerLatencyTimingTest();
  });
  describe('Exp 2: Read Latency Injection', function () {
    registerLatencyRestoreTest();
  });
});
